...
<div class="container">
		...
		<div class="mypage_member_wrap">
		      ...
		      <div class="personal-account-info container" style="padding: 0px;margin: 0px;">
				   <div class="my-account row"style="padding: 0px;margin: 0px;">
				   <div>
					      <section class="col-xs-24 my-info">
					         <div class="section-body">
					            <div class="item cash col-xs-8 col-md-6" style="border-right:3px solid #cccccc; width: 25%;">
					               <strong>
					            ...
					            <div class="item cash col-xs-8 col-md-6" style="width: 25%;">
						            <div class="mygrade">
				       ...
				       <div class="category" style="padding-left:0px; margin-left: auto;margin-right: auto;">
					         <ul style="float: left;">
