...
<link rel="stylesheet" type="text/css" href="/SG/resources/file/css/joinAgreement.css" />

<title>회원 약관 동의 폼</title>
      ...
      <div class="xans-member-joinAgreement">
         ...
         <h3>이용약관</h3>   
            <div class="agree">
                 ...
                 이 약관은&nbsp;샐구 기업(전자상거래 사업자)이 운영하는&nbsp;샐러드 구쁘다 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.</p>
               <p>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」</p>
               <p>제2조(정의)<br>
                 ①“몰” 이란 샐구 기업 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</p>
