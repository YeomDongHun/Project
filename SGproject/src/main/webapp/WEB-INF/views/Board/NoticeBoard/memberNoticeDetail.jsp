...
<tr>
	<td>제목</td>
    <td colspan=3 style="background:white;">${notice.NOTICE_TITLE}</td>
</tr>
<tr>
	<td>작성자</td>
...
<tr>
	<td>등록일</td>
    <td style="background:white;">${notice.NOTICE_REGDATE}</td>
    <td>조회수</td>
    <td style="background:white;">${notice.NOTICE_HITCOUNT}</td>
</tr>

<tr>
	<td colspan=4 style="background:white;"><img src="./resources/file/noticeFile/${notice.NOTICE_IMAGE}"></td>
</tr>

<tr>
	<td colspan=4 style="background:white;">${notice.NOTICE_CONTENT}</td>
</tr> 
</table>
